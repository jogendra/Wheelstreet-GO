...
struct GoDefaults {
    ...
    static let goGoogleMapsApiKey: String = "AIzaSyAZxhGNAJ4w5FTU-w-jbpyaZjLe1ywC7yc"
    
    static let goGooglePlacesApiKey: String = "AIzaSyDIg1qMybofuyThy7mTI7IDAD1SDicSwHk"
